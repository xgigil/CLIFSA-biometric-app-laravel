...
import { IconFilter2, IconCircleCheckFilled, IconAlarmFilled, IconCircleXFilled, IconCalendar } from "@tabler/icons-react";
...
const FILTERABLE_STATUSES = ["present", "late", "absent", "on_leave"] as const;
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-36">
        ...
        {/* added on_leave status to the filter */}
        <DropdownMenuCheckboxItem
